...
export interface HomeCopy {
  ...
  privacyFirst: string; privacyDetail: string; theme: string; language: string;
...
export const homeCopy: Record<Locale, HomeCopy> = {
  en: {
    ...
    privacyFirst: 'Privacy-first', privacyDetail: 'Text, documents, code, and images are processed locally in your browser.', theme: 'Toggle color theme', language: 'Choose language', footerPrivacy: 'Zero text, prompts, or uploaded files are sent to any external server.',
  ...
  ja: {
    ...
    privacyFirst: 'プライバシー優先', privacyDetail: 'テキスト、文書、コード、画像はブラウザ内でローカル処理されます。', theme: 'カラーテーマを切り替える', language: '言語を選択', footerPrivacy: 'テキスト、プロンプト、アップロードしたファイルを外部サーバーへ送信しません。', methodologyNav: '計算方法', about: '概要', privacy: 'プライバシー', terms: '利用規約', contact: 'お問い合わせ', howItWorks: '仕組み', measurementHeading: '推測ではなく、技術的根拠に基づく測定です。', pricingNote: '各結果には計算方式と精度レベルを表示します。料金はModels.devから更新され、内蔵レジストリがオフライン時の代替になります。', methodologyLink: '計算方法の詳細 →',
  ...
  de: {
    ...
    privacyFirst: 'Datenschutz zuerst', privacyDetail: 'Text, Dokumente, Code und Bilder werden lokal in deinem Browser verarbeitet.', theme: 'Farbschema wechseln', language: 'Sprache auswählen', footerPrivacy: 'Texte, Prompts und hochgeladene Dateien werden an keinen externen Server gesendet.', methodologyNav: 'Methodik', about: 'Über uns', privacy: 'Datenschutz', terms: 'Bedingungen', contact: 'Kontakt', howItWorks: 'Funktionsweise', measurementHeading: 'Eine technische Messung, keine als Tatsache getarnte Vermutung.', pricingNote: 'Jedes Ergebnis nennt Methode und Genauigkeitsstufe. Preise werden über Models.dev aktualisiert; das integrierte Register dient als Offline-Rückfall.', methodologyLink: 'Vollständige Methodik lesen →',
