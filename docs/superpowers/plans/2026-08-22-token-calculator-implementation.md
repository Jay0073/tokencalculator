...
4. **Calculator** — Build the two-column instrument layout, text/file/image modes, model selector, accuracy labels, context ruler, costs, theme, responsive behavior, and worker-based live calculation.
